...
public class ForecastAdapter extends CursorAdapter {
    ...
    public void bindView(View view, Context context, Cursor cursor) {
        ...
        switch (viewType) {
            case VIEW_TYPE_TODAY: {
                //viewHolder.iconView = (ImageView) view.findViewById(R.id.list_item_icon_today);
                // Get weather icon
                Log.d("inside bindView: (4): ", cursor.getString(4));
                Log.d("inside bindView: ", Integer.toString(cursor.getInt(MainActivityFragment.COL_WEATHER_CONDITION_ID)));
            ...
            case VIEW_TYPE_FUTURE_DAY: {
                //viewHolder.iconView = (ImageView) view.findViewById(R.id.list_item_icon_general);
                // Get weather icon
